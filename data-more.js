 ...
 *    figure listed here (21 Sep 2026). Her SLIDE figures (ovulation, uterus-wall arteries, her slide eye and ear) are not hosted anywhere yet, so they are not here. `labelled:true` = her picture carries the names, so it must never show while a question is open. ── */
